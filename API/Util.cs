...
public static class Util
{
    ...
    {
        return canvas.Children.Cast<FrameworkElement>()
            .Where(c => c is not InkCanvas)
            .Any(c => GetControlBounds(c).Contains(position));
    }
    ...
    public static Rect GetControlBounds(FrameworkElement control)
    {
        return new Rect(control.Margin.Left - 5, control.Margin.Top - 5, control.ActualWidth + 5,
